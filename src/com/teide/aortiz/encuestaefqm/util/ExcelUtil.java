...
public class ExcelUtil {
    ...
    public static final String HOJA_COMENTARIOS = "comentariosProfesores.xls";
    ...
    public void hojaComentariosProfesores (String curso) throws Exception {
        ...
        WorkbookSettings opciones= new WorkbookSettings();
        opciones.setEncoding("iso-8859-1");
        WritableWorkbook workbook = Workbook.createWorkbook(new File(directorio, HOJA_COMENTARIOS), opciones);
